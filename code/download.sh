...
cd /home1/zhuyixin/sc1/ImmAssm/hifi_bam/mBalAcu1/

for f in https://genomeark.s3.amazonaws.com/species/Balaenoptera_acutorostrata/mBalAcu1/genomic_data/pacbio_hifi/*bam ; do echo $f; wget $f ; done
