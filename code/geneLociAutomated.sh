...
do 
    ...
    awk -F"\t" 'NR==1 {val = "End"} NR > 1 {val = $1+$3} {$(++NF) = val; print}' OFS='\t' ${HOME}/gene_position/${function}/${line}/temp1.txt > ${HOME}/gene_position/${function}/${line}/temp2.txt
    ...
    awk -F'\t' '{print $1 "\t" $2 "\t" $4 "\t" NR "\t" "0" "\t" $3 }' ${HOME}/gene_position/${function}/${line}/gene_IGH_pos.txt > ${HOME}/gene_position/${function}/${line}/gene_IGH_pos.bed
    #sort the bed file
